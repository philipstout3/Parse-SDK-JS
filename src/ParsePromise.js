...
var _classCallCheck3 = function (instance, Constructor) {
    if (!(instance instanceof Constructor)) {
        throw new TypeError("Cannot call a class as a function");
    }
}
  
var _createClass3 = function (Constructor, protoProps, staticProps) {
      if (protoProps) {
...
const ParsePromise = function() {
    ...
    (0, _createClass3)(ParsePromise, [{
        ...
        value: function (optionsOrCallback, model) {
          ...
          } else if ((typeof optionsOrCallback === 'undefined' ? 'undefined' : (0, _typeof3)(optionsOrCallback)) === 'object') {
